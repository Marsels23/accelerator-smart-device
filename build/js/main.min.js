...
/* harmony import */ var _modules_toggle__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/toggle */ "./js/modules/toggle.js");
...
/* harmony import */ var _modules_validator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/validator */ "./js/modules/validator.js");
/* harmony import */ var _modules_validator__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_validator__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_mobile_text__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/mobile-text */ "./js/modules/mobile-text.js");
/* harmony import */ var _modules_mobile_text__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_mobile_text__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _modules_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/utils */ "./js/modules/utils.js");
/* harmony import */ var _modules_utils__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_utils__WEBPACK_IMPORTED_MODULE_6__);
...
var verticalMenu = document.querySelectorAll('[data-accordion]');
verticalMenu.forEach(function (accordion) {
  verticalMenu.forEach(function (ac) {
...
function textMobile() {
  if (window.screen.width < 768) {
    document.querySelectorAll('[data-name-mobile]').forEach(function (el) {
      el.innerHTML = el.dataset.nameMobile;
    });
  } else {
    document.querySelectorAll('[data-name-desktop]').forEach(function (el) {
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      setTimeout(function () {
        ...
        modal.querySelector('input[data-input-name]').focus();
...
document.querySelectorAll('[data-toggle]').forEach(function (toggle) {
  var aboutText = toggle.querySelector('[data-toggle-text]');
  var aboutButton = toggle.querySelector('[data-toggle-btn]');
  aboutButton.addEventListener('click', function (event) {
    event.preventDefault();
    aboutText.classList.toggle('company__texts--closed');
    aboutText.classList.toggle('company__texts--open');
    var _ref = [btn.innerHTML, btn.dataset.toggleText];
    aboutButton.dataset.toggleText = _ref[0];
    btn.innerHTML = _ref[1];
  });
});
...
window.addEventListener('DOMContentLoaded', function () {
  document.querySelectorAll('[data-input-checkbox]').forEach(function (input) {
    input.nextElementSibling.addEventListener('keydown', function (event) {
      if (event.keyCode === 13) {
...
if (forms[0]) {
  forms.forEach(function (form) {
    ...
    var phone = form.querySelector('[data-input-phone]');
    var check = form.querySelector('[data-input-checkbox]');
    var textarea = form.querySelector('[data-input-textarea]');
